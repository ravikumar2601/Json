...
public class FCALoginPage extends FunctionalLibrary {
    private static final Log logger = LogFactory.getLog(FCALoginPage.class);
    ...
    public FCALoginPage(WebDriver driver) {
        super(driver);
    }

    public FCALoginPage inputUserName(String username) {
    ...
    public FCALoginPage inputPassword(String password) {
    ...
    public FCALoginPage loginButton() {
