...
public class FORDHomePage extends FunctionalLibrary {
    private static final Log logger = LogFactory.getLog(FORDHomePage.class);
    ...
    public FORDHomePage(WebDriver driver) {
        super(driver);
    }
    ...
    public FORDHomePage inputMake(String sheet, int row, int col) throws IOException {
    ...
    public FORDHomePage inputYear(String sheet, int row, int col) throws IOException {
    ...
    public FORDHomePage inputModel(String sheet, int row, int col) throws IOException {
    ...
    public FORDHomePage inputVIN(String sheet, int row, int col) throws IOException {
    ...
    public FORDHomePage searchBtnClick() {
    ...
    public FORDHomePage clickPartSubPartCategories() {
        ...
        for (int i = 1; i < 3; i++) {
            ...
            for (int j = 1; j < 2; j++) {
                ...
                if (illustration == 0) {
                    ...
                    for (int k = 1; k < 2; k++) {
                        ...
                        waitInSec(25);
                        callOut1.click();
                        logger.info("Callout Clicked");
                        waitInSec(20);
                        backBtn.click();
                        logger.info("Back to Part Categories page");
                        waitInSec(25);
                        try {
                            if (engineDropDown != null) {
                                waitInSec(5);
            ...
            waitInSec(30);
            fluentWait(activePartCategories);
            activePartCategories.click();
            logger.info("ActivePartCategories Clicked ");
        }
        return this;
    }

    public FORDHomePage inputSearchKeyword(String string) {
    ...
    public FORDLoginPage logoutBtnClick() {
        logger.info(": logoutBtnClick method start");
        waitInSec(5);
        scrollToTheTop();
        fluentWait(logoutBtn);
        logoutBtn.click();
        return new FORDLoginPage(getDriver());
    }
